...
public class MainInterface extends javax.swing.JFrame {
	...
	private JPanel setButtonsDrawingCanvasPanel() {
		...
		//z-value:
		final JButton increaseZ = new JButton("+");
		increaseZ.setFont(buttonsFont);
		increaseZ.addMouseListener(new SetZvalue(true));
		final JButton decreaseZ = new JButton("-");
